...
app.controller('myCtrl',function($scope){
	$scope.selectNode="123";
	$scope.dataset=[];
	var aa=[ 
	        { id: 1, pId: 0, name: "普通的父节点", t: "我很普通，随便点我吧", open: true }, 
	        { id: 11, pId: 1, name: "叶子节点 - 1", t: "我很普通，随便点我吧" }, 
	        { id: 111, pId: 11, name: "叶子节点 - 1-1", t: "我很普通，随便点我吧" }, 
	        { id: 112, pId: 11, name: "叶子节点 - 1-2", t: "我很普通，随便点我吧" }, 
	        { id: 113, pId: 11, name: "叶子节点 - 1-3", t: "我很普通，随便点我吧" }, 
	      ...
	      var setting = { 
	        ...
	        callback: { 
				onCheck:function(event, treeId, treeNode){
					var obj=$.fn.zTree.getZTreeObj(element[0].id);
					$scope.$apply(function () { 
						var data=obj.getNodesByParam('checked',true).map(function(item){return item.id});
	              		$scope.ngModel=data;
	            	}); 
				}
	        } 
